		...
		<div class="nav">
			...
			<div class="menu">
				...
				<ul>
					...
					<li class="menu-item"><a href="./page/nos.html">Sobre nós</a></li>
 ...
 %> </h9>
	...
	<div class="menu2" id="menu2Id">
		<a href="#cursos"><li>Cursos</li></a> <a href="./page/nos.html"><li>Sobre
				nós</li></a> <a href="login.jsp"><li>Login</li></a> <a href="#cardFooter"><li>Contatos</li></a>
			...
			<div class="carousel-item active" data-bs-interval="10000">
				<section class="home">
					<div class="home-text">
						...
						<p>Na vanguarda da revolução tecnológica, a Next-Level é o seu
							destino definitivo para aprimorar suas habilidades e impulsionar
							sua carreira no mundo da Tecnologia da Informação. Oferecemos uma
							ampla gama de cursos especializados, ministrados por
							especialistas da indústria, para ajudá-lo a dominar as
							tecnologias mais recentes e atender às demandas do mercado de
							trabalho em constante evolução.</p>
						<a href="./page/nos.html" class="home-btn">Sobre nós</a>
					</div>
	...
	<h1 class="textCurso" id="cursos">Conheça Todos os Cursos</h1>
	<div class="containerCardCursos">
		<div class="card" id="cardAllCourse" style="width: 18rem">
			...
			<div class="card-body">
				...
				<p class="card-text">Prepare-se para dominar o desenvolvimento
					Full Stack, explorando todas as camadas para uma carreira dinâmica
		...
		<div class="card" style="width: 18rem">
			<img class="card-img-top"
				src="img/imgCurso/Engenharia da Computação.jpg"
				alt="Imagem de capa do card" />
			<div class="card-body">
				<h5 class="card-title">Engenharia da Computação</h5>
				<p class="card-text">Curso de Engenharia da Computação: Explore
					inovação, lidere a revolução digital, desenvolva habilidades
		...
		<div class="card" style="width: 18rem">
			<img class="card-img-top" src="img/imgCurso/Ciência de Dados.jpg"
				alt="Imagem de capa do card" />
			<div class="card-body">
				<h5 class="card-title">
				...
				<p class="card-text">Desvende segredos em dados! Nosso curso de
					Ciência de Dados capacita você a analisar informações, tornando-se
					um mestre na revolução, moldando o futuro com insights
					significativos.</p>
		...
		<div class="card" style="width: 18rem">
			...
			<div class="card-body">
				...
				<p class="card-text">Domine a gestão de dados para impulsionar
					sua carreira com o Curso de Banco de Dados: destaque-se no mercado
					de TI com uma jornada prática e envolvente.</p>
		...
		<div class="card" style="width: 18rem">
			...
			<div class="card-body">
				...
				<p class="card-text">Nosso Curso de Redes de Computadores
					capacita líderes para o futuro digital, promovendo imersão completa
					e troca instantânea de informações globais.</p>
		...
		<div class="card" style="width: 18rem">
			...
			<div class="card-body">
				<h5 class="card-title">
					Defesa Cibernética <br /> <br />
				</h5>
				<p class="card-text">Curso de Defesa Cibernética: Imersão
					completa na segurança online, capacitando para enfrentar ameaças
		...
		<div class="card" style="width: 18rem">
			<img class="card-img-top" src="img/imgCurso/Digitar.jpg"
				alt="Imagem de capa do card" />
			<div class="card-body">
				<h5 class="card-title">Análise e Desenvolvimento</h5>
				<p class="card-text">Transforme sua paixão pela tecnologia em
					habilidades práticas com nosso Curso de Análise e Desenvolvimento,
		...
		<div class="card" style="width: 18rem">
			...
			<div class="card-body">
				...
				<p class="card-text">Junte-se à revolução DevOps: curso
					abrangente para integrar inovação, automação e colaboração no
		...
		<div class="card" style="width: 18rem">
			...
			<div class="card-body">
				...
				<p class="card-text">Curso de Ciência da Computação: jornada
					intelectual para desvendar tecnologia, explorar algoritmos e moldar
					o futuro digital, com imersão nos fundamentos e avanços.</p>
		...
		<div class="card" style="width: 18rem">
			<img class="card-img-top" src="img/imgCurso/Casal.webp"
				alt="Imagem de capa do card" />
			<div class="card-body">
				<h5 class="card-title">Licenciatura em Computação</h5>
				<p class="card-text">Curso de Licenciatura em Computação
					inovador une educação e tecnologia, capacitando educadores digitais
					para moldar mentes e inspirar inovação na próxima geração.</p>
	...
	<footer>
		...
		<div class="cardFooter">
			...
			<li><a href="./page/nos.html">Sobre nós</a></li>
